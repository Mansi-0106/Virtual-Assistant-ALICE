...
if __name__ == '__main__':
    ...
    while True:
        ...
        if "good bye" in statement or "ok bye" in statement or "stop" in statement or "bye" in statement:
            speak('your personal assistant Alice is shutting down,Good bye mam')
            print('your personal assistant Alice is shutting down,Good bye mam')
            break
        ...
        if "from wikipedia" in statement:
            ...
            print(
                'I am Alice version 1.o a personal assistant created by Mansi . I am programmed to execute minor tasks like'
            ...
            speak("I have been created by MANSI JOSHI or say MINTI.")
            print("I have been created by MANSI JOSHI or say MINTI")
